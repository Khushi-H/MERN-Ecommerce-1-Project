...
const sortOptions = [
  { name: "Rating", sort: "rating", current: false },
  { name: "Price: Low to High", sort: "discountPrice", current: false },
  { name: "Item Name", sort: "title", current: false },
];
...
function Pagination({ sort, page, setPage, handlePage, totalItems = 97 }) {
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          {/* <p className="text-sm text-gray-700">
            ...
            to{" "}
            <span className="font-medium">
              {page * ITEMS_PER_PAGE > 98 ? 98 : page * ITEMS_PER_PAGE}
            </span>{" "}
